...
## ・ユーザーが抱える課題
1. 似たような嗜好を持つ仲間と「プラモづくり」の楽しさを共有したいが、SNSだけでは物足りない。
...
2. 終日をプラモ作りに費やす時間はないので、隙間時間にちょっとづつ作りたいがうまくいってない。
