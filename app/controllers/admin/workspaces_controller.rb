class Admin::WorkspacesController < Admin::BaseController
  ...
  def create
    ...
    if @admin_workspace.save
      redirect_to @admin_workspace, notice: "Workspace was successfully created."
    else
  ...
  def update
    if @admin_workspace.update(admin_workspace_params)
      redirect_to admin_workspace_path(@admin_workspace), notice: "Workspace was successfully updated."
    else
  ...
  def destroy
    ...
    redirect_to admin_workspaces_url, notice: "Workspace was successfully destroyed."
  end
